...
python. These arguments are everything after the word python. So
...
# Colors of the bricks, repeating every 10 rows
BRICK_COLORS = [colormodel.RED,colormodel.RED,
                colormodel.ORANGE,colormodel.ORANGE,
                colormodel.YELLOW,colormodel.YELLOW,
                colormodel.GREEN,colormodel.GREEN,
                colormodel.CYAN,colormodel.CYAN]

#Color of all the text in the game
TEXT_COLOR = colormodel.BLACK

#Countdown timer; based on 60fps
ONE_SECOND = 60
TWO_SECOND = 120
THREE_SECOND = 180
FOUR_SECOND = 240
